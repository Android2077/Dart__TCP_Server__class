...
void main() async
{
  ...
  //- set__ReadParamFlag_for_Socket               - устанавливает режим чтения данных из Сокета на Аццепторе.          Общий для всех Сокетов Аццептора.
  //- set__ReadUntill_Seperator_for_Socket        - устанавливает "разделитель" для режима чтения "ReadUntill".        Общий для всех Сокетов Аццептора.
  //- set__AccumulateBuffer_Size_for_Socket       - устанавливает размер буффера для режима чтения "AccumulateBuffer". Общий для всех Сокетов Аццептора.
  //- send__Bytes_to_socket                       - отправляет данные в Сокет.

  //Методы Сокета:
  //- set__ReadParamFlag_for_Socket               - устанавливает режим чтения данных из Сокета на Аццепторе.          Индивидуально для кокнретного Сокета Аццептора.
  //- set__ReadUntill_Seperator_for_Socket        - устанавливает "разделитель" для режима чтения "ReadUntill".        Индивидуально для кокнретного Сокета Аццептора.
  //- set__AccumulateBuffer_Size_for_Socket       - устанавливает размер буффера для режима чтения "AccumulateBuffer". Индивидуально для кокнретного Сокета Аццептора.
  ...
  void Function(TCP_Server__class TCP_Server__class__ref, Acceptor_struct Acceptor_struct__ref, Socket_Struct? Socket_Struct__ref, bool Connection_flag) lambda_for_ConnectionStatus = (TCP_Server__class TCP_Server__class__ref, Acceptor_struct Acceptor_struct__ref, Socket_Struct? Socket_Struct__ref, bool Connection_flag)
  {
    ...
    //Socket_Struct__ref!.set__ReadParamFlag_for_Socket(read_flag.Accumulate_buffer);   //Меняем режим чтения Индивидуально у конкретного только что Созданного Сокета, есди требуется.
    //Socket_Struct__ref!.set__AccumulateBuffer_Size_for_Socket(5);                     //Меняем размер на копительного буффера у конкретного только что Созданного Сокета, есди требуется.
  ...
  Function(TCP_Server__class TCP_Server__class__ref, Acceptor_struct Acceptor_struct__ref, Socket_Struct Socket_Struct_ref, Uint8List Incoming_data) user_func_Read = (TCP_Server__class TCP_Server__class__ref, Acceptor_struct Acceptor_struct__ref, Socket_Struct Socket_Struct_ref, Uint8List Incoming_data)
  {
    ...
    //Socket_Struct_ref.set__AccumulateBuffer_Size_for_Socket(6);   //Меняем размер накопительного буффера Индивидуально у конкретного Сокета, если требуется.
  };
  //----------------------------------------------------------------------------------------------
  ...
  //Устанавливает для всех Сокетов Аццептора параметр Чтения Входящих данных.
  //Если нужно после создания Сокета(после нового соединения на Аццеторе) - изминть данный параметр индивидуально для конкретного Сокета, то нужно вызвать такой же метод, только уже у Структуры Сокета.
